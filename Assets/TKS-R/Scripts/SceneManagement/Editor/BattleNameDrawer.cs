...
namespace TKSR
{
    [CustomPropertyDrawer(typeof(BattleNameAttribute))]
    public class BattleNameDrawer : PropertyDrawer
    {
        int m_SceneIndex = -1;
        ...
        void Setup(SerializedProperty property)
        {
            ...
            string[] scenes = AssetDatabase.FindAssets("t:scene", new[] {"Assets/TKS-R/Scenes/BattleScenes"});
            if (scenes.Length == 0)
                return;
