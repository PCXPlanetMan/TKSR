...
namespace TKSR
{
    ...
    public class TransitionStartEditor : Editor
    {
        ...
        SerializedProperty m_DeployGameObjectProp;
        ...
        private SerializedProperty m_BattleSceneNameProp;
        ...
        void OnEnable ()
        {
            ...
            m_DeployGameObjectProp = serializedObject.FindProperty("deployGameObject");
            ...
            m_BattleSceneNameProp = serializedObject.FindProperty("battleSceneName");
        }
        ...
        public override void OnInspectorGUI ()
        {
            ...
            else if ((TransitionPoint.TransitionType)m_TransitionTypeProp.enumValueIndex ==
                     TransitionPoint.TransitionType.OnlyDeploy)
            {
                EditorGUILayout.PropertyField (m_DeployGameObjectProp);
            }
            else if ((TransitionPoint.TransitionType)m_TransitionTypeProp.enumValueIndex ==
                     TransitionPoint.TransitionType.BattleScene)
            {
                EditorGUILayout.PropertyField (m_BattleSceneNameProp);
            }
            else
            {
