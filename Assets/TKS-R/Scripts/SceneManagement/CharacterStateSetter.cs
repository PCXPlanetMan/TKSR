...
namespace TKSR
{
    ...
    public class CharacterStateSetter : MonoBehaviour
    {
        ...
        public EnumFaceDirection facingDirection;
        ...
        public void SetCharacterState ()
        {
            ...
            {
                playerCharacter.UpdateFacingDirection(facingDirection);
            }
            ...
            // if (disableCollider)
            // {
            //     var collider2D = playerCharacter.gameObject.GetComponent<Collider2D>();
            //     if (collider2D != null)
            //     {
