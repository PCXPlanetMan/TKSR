...
namespace TKSR
{
    ...
    public class CharacterStateSetterEditor : Editor
    {
        ...
        SerializedProperty m_MainRoleControllerProp;
        SerializedProperty m_SetCharacterFacingProp;
        SerializedProperty m_FacingDirectionProp;
        ...
        GUIContent m_FacingDirectionContent;  
        ...
        void OnEnable ()
        {
            ...
            m_MainRoleControllerProp = serializedObject.FindProperty("playerCharacter");
            m_SetCharacterFacingProp = serializedObject.FindProperty ("setCharacterFacing");
            m_FacingDirectionProp = serializedObject.FindProperty ("facingDirection");
            ...
            m_SetCharacterFacingContent = new GUIContent("Set Character Facing Direction");
            m_FacingDirectionContent = new GUIContent("Facing Direction");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            {
                EditorGUILayout.PropertyField(m_MainRoleControllerProp, m_PlayerCharacterContent);
                EditorGUILayout.PropertyField(m_FacingDirectionProp, m_FacingDirectionContent);
            }
