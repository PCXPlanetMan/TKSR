    ...
    public abstract class InputComponent : MonoBehaviour
    {
        ...
        public class InputTouch
        {
            ...
            public void Get(InputType inputType)
            {
                ...
                ReceivingInput = Input.GetMouseButton(0) || Input.GetMouseButtonDown(0);
                if (inputType != InputType.Touch)
                {
                    ReceivingInput = false;
                }
        ...
        protected void GainControl(InputTouch inputTouch)
        {
            inputTouch.GainControl();
        }
        ...
        protected void ReleaseControl(InputTouch inputTouch, bool resetValues)
        {
            inputTouch.ReleaseControl(resetValues);
        }
    }
}
