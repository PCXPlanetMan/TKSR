...
namespace TKSR
{
	...
	[CustomEditor(typeof(TKSRChatBubble))]
	public class TKSRChatBubbleEditor : Editor
	{
		new TKSRChatBubble target { get { return base.target as TKSRChatBubble; } }
		...
		public override void OnInspectorGUI()
		{
			...
			TKSRChatBubble.BindingsExpanded = EditorGUILayout.Foldout(TKSRChatBubble.BindingsExpanded, "Bindings");
			if (TKSRChatBubble.BindingsExpanded )
			{
				EditorGUI.indentLevel++;
			...
			TKSRChatBubble.ExtenderExpanded = EditorGUILayout.Foldout(TKSRChatBubble.ExtenderExpanded, "Extender");
			if (TKSRChatBubble.ExtenderExpanded)
			{
				EditorGUI.indentLevel++;
			...
			TKSRChatBubble.ValuesExpanded = EditorGUILayout.Foldout(TKSRChatBubble.ValuesExpanded, "Values");
			if (TKSRChatBubble.ValuesExpanded)
			{
				EditorGUI.indentLevel++;
